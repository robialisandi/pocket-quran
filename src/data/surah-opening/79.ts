const opening = `<span class="gen"><br> Surat An Naazi´aat terdiri atas 46 ayat, termasuk golongan surat-surat Makkiyah, diturunkan sesudah surat An Naba´. Dinamai <i>An Naazi´aat</i> diambil dari perkataan <i>An Naazi´aat</i> yang terdapat pada ayat pertama surat ini. Dinamai pula <i>as Saahirah</i> yang diambil dari ayat 14, dinamai juga <i>Ath Thaammah</i> diambil dari ayat 34.<br><br> Pokok-pokok isinya:<br><i>1. Keimanan:</i><br> Penegasan Allah tentang adanya hari kiamat dan sikap orang- orang musyrik terhadapnya; manusia dibagi 2 golongan di akhirat; manusia tidak dapat mengetahui kapan terjadinya saat kiamat.<br><i>2. Kisah:</i><br> Kisah Musa a.s. dengan Fir´aun.<br><br></span>`
