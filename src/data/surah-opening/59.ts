const opening = `<span class="gen"><br> Surat Al Hasyr terdiri atas 24 ayat, termasuk golongan surat-surat Madaniyyah, diturunkan sesudah surat Al Bayyinah.<br> Dinamai surat <i>Al Hasyr</i> (pengusiran) diambil dari perkataan <i>Al-Hasyr</i> yang terdapat pada ayat 2 surat ini. Di dalam surat ini disebutkan kisah pengusiran suatu suku Yahudi yang bernama Bani Nadhir yang berdiam di sekitar kota Madinah.<br><br> Pokok-pokok isinya :<br><br><i>1. Keimanan:</i><br> Apa yang berada di langit dan di bumi semuanya bertasbih memuji Allah; Allah pasti mengalahkan musuh-Nya dan musuh-musuh Rasul-Nya; Allah mempunyai Al Asmaa-ul Husna; keagungan Al Quran dan ketinggian martabatnya.<br><i>2. Hukum-hukum:</i><br> Cara pembagian harta fai-i; perintah bertakwa dan menyiapkan diri untuk kehidupan ukhrawi.<br><i>3. Dan lain-lain:</i><br> Beberapa sifat orang-orang munafik dan orang-orang ahli kitab yang tercela; peringatan-peringatan untuk kaum muslimin.<br><br></span>`
