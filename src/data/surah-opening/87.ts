const opening = `<span class="gen"><br> Surat ini terdiri atas 19 ayat, termasuk golongan surat-surat Makkiyyah, dan diturunkan sesudah surat At Takwiir. Nama <i>Al A´laa</i> diambil dari kata <i>Al A´laa</i> yang terdapat pada ayat pertama, berarti <i>Yang Paling Tinggi</i>. Muslim meriwayatkan dalam kitab Al Jumu'ah, dan diriwayatkan pula oleh Ashhaabus Sunan, dari Nu'man ibnu Basyir bahwa Rasulullah s.a.w. pada shalat dua hari Raya (Fitri dan Adha) dan shalat Jum'at membaca surat Al A´laa pada rakaat pertama, dan surat Al Ghaasyiyah pada rakaat kedua.<br><br> Pokok-pokok isinya :<br> Perintah Allah untuk bertasbih dengan menyebut nama-Nya. Nabi Muhammad s.a.w. sekali-kali tidak lupa pada ayat-ayat yang dibaca- kan kepadanya. Jalan-jalan yang menjadikan orang sukses hidup dunia dan akhirat. Allah menciptakan, menyempurnakan ciptaan-Nya, menentukan kadar-kadar, memberi petunjuk dan melengkapi keperluan- keperluannya sehingga tercapai tujuannya.</span>`
