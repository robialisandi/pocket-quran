const opening = `<span class="gen"><br> Surat Al Buruuj terdiri atas 22 ayat, termasuk golongan surat-surat Makkiyyah diturunkan sesudah surat Asy-Syams.<br><br> Dinamai <i>Al Buruuj</i> (gugusan bintang) diambil dari perkataan <i>Al Buruuj</i> yang terdapat pada ayat 1 surat ini.<br><br> Pokok-pokok isinya:<br> Sikap dan tindakan-tindakan orang-orang kafir terhadap orang-orang yang mengikuti seruan para rasul; bukti-bukti kekuasaan dan keesaan Allah; isyarat dari Allah bahwa orang-orang kafir Mekah akan ditimpa azab sebagaimana kaum Fir'aun dan Tsamud telah ditimpa azab; jaminan Allah terhadap kemurnian Al Quran.<br><br></span>`
