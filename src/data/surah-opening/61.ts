const opening = `<span class="gen"><br> Surat Ash Shaff terdiri atas 14 ayat termasuk golongan surat-surat Madaniyyah. Dinamai dengan <i>Ash Shaff</i>, karena pada ayat 4 surat ini terdapat kata <i>Shaffan</i> yang berarti <i>satu barisan</i>. Ayat ini menerangkan apa yang diridhai Allah sesudah menerangkan apa yang dimurkai-Nya. Pada ayat 3 diterangkan bahwa Allah murka kepada orang yang hanya pandai berkata saja tetapi tidak melaksanakan apa yang diucapkannya. Dan pada ayat 4 diterangkan bahwa Allah menyukai orang yang mempraktekkan apa yang diucapkannya yaitu orang-orang yang berperang pada jalan Allah dalam satu barisan.<br><br> Pokok-pokok isinya:<br> Semua yang ada di langit dan di bumi bertasbih kepada-Nya, anjuran berjihad pada jalan Allah. Pengikut-pengikut nabi Musa dan Isa a.s. pernah mengingkari ajaran-ajaran nabi mereka. Demikian pula kaum musyrikin Mekah ingin hendak memadamkan cahaya Allah (agama Islam). Ampunan Allah dan Surga tak dapat dicapai dengan iman dan berjuang menegakkan kalimah Allah dengan harta dan jiwa.<br><br></span>`
