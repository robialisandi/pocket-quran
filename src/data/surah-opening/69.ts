const opening = `<span class="gen"><br> Surat ini terdiri atas 52 ayat,termasuk golongan surat-surat Makkiyah,diturunkan sesudah surat Al Mulk.<br> Nama <i>Al Haaqqah</i> diambil dari kata <i>Al Haaqqah</i> yang terdapat pada ayat pertama surat ini yang artinya <i>hari kiamat</i><br><br> Pokok-pokok isinya:<br> Peringatan tentang azab yang ditimpakan kepada kaum-kaum Tsamud, 'Aad, Fir'aun, kaum Nuh dan kaum-kaum sebelum mereka yang mengingkari rasul-rasul mereka pada hari kiamat; kejadian-kejadian mereka pada hari kiamat dan hari berhisab; penegasan Allah bahwa Al Quran itu benar-benar wahyu Allah.<br><br></span>`
