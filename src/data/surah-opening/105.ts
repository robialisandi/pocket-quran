const opening = `<span class="gen"><br> Surat ini terdiri atas 5 ayat, termasuk golongan surat-surat Makkiyyah, diturunkan sesudah surat Al Kaafirun. Nama <i>Al Fiil</i> diambil dari kata <i>Al Fiil</i> yang terdapat pada ayat pertama surat ini, artinya <i>gajah</i>. Surat Al Fiil mengemukakan cerita pasukan bergajah dari Yaman yang dipimpin oleh Abrahah yang ingin meruntuhkan Ka'bah di Mekah. Peristiwa ini terjadi pada tahun Nabi Muhammad s.a.w. dilahirkan.<br><br> Pokok-pokok isinya:<br> Cerita tentang pasukan bergajah yang diazab oleh Allah s.w.t. dengan mengirimkan sejenis burung yang menyerang mereka sampai binasa.<br><br></span>`
