const opening = `<span class="gen"><br> Surat Al Mujaadilah terdiri atas 22 ayat, termasuk golongan surat Madaniyyah, diturunkan sesudah surat Al Munaafiquun. Surat ini dinamai dengan <i>Al Mujaadilah</i> (wanita yang mengajukan gugatan) karena pada awal surat ini disebutkan bantahan seorang perempuan, menurut riwayat bernama Khaulah binti Tsa'labah terhadap sikap suaminya yang telah menzhiharnya. Hal ini diadukan kepada Rasulullah s.a.w. dan ia menuntut supaya beliau memberikan putusan yang adil dalam persoalan itu. Dinamai juga <i>Al Mujaadalah</i> yang berarti <i>perbantahan</i>.<br><br> Pokok-pokok isinya:<br><i>1. Hukum:</i><br> Hukum zhihar dan sangsi-sangsi bagi orang yang melakukannya bila ia menarik kembali perkataannya; larangan menjadikan musuh Allah sebagai teman.<br><i>2. Dan lain-lain:</i><br> Menjaga adab sopan santun dalam suatu majlis pertemuan; adab sopan santun terhadap Rasulullah s.a.w.<br><br></span>`
