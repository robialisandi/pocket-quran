const opening = `<span class="gen"><br> Surat Al Balad terdiri atas 20 ayat, termasuk golongan surat-surat Makkiyyah, diturunkan sesudah surat Qaaf. Dinamai <i>Al Balad</i>, diambil dari perkataan <i>Al Balad</i> yang terdapat pada ayat pertama surat ini. Yang dimaksud dengan kota di sini ialah kota Mekah.<br><br> Pokok-pokok isinya:<br><br> Manusia diciptakan Allah untuk berjuang menghadapi kesulitan; janganlah manusia terpedaya oleh kekuasaan dan harta benda yang banyak yang telah dibelanjakannya; beberapa peringatan kepada manusia atas beberapa nikmat yang telah diberikan Allah kepadanya dan bahwa Allah telah menunjukkan jalan-jalan yang akan menyampaikannya kepada kebAhagiaan dan yang akan membawanya kepada kecelakaan.<br><br></span>`
